...
export const CreatorDashboardView: React.FC<Props> = ({ articles, userProfile, onNavigate }) => {
  ...
  const [studioSection,setStudioSection]=useState<'analytics'|'commerce'|'seller'|'earnings'|'payouts'|'digital-products'>('analytics');
