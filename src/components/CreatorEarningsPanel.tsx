...
export const CreatorEarningsPanel: React.FC = () => {
  ...
  return <section className="space-y-4">
    <div className="border-4 border-black bg-[var(--color-primary)] p-5 neo-shadow">
      ...
      <p className="font-mono text-[10px] mt-2 max-w-3xl">Server-calculated sales allocation after the configured OFFSCRPT commission rule. This is not a withdrawable balance; withdrawable balance is managed separately by V94 Payouts.</p>
    </div>
