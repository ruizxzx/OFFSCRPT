      ...
      <div className="grid lg:grid-cols-[minmax(0,1.15fr)_420px] gap-6 mt-5 items-start">
        ...
        <aside className="order-1 lg:order-2 border-4 border-black bg-white shadow-[7px_7px_0_#000] lg:sticky lg:top-24 overflow-hidden">
          <div className="p-5 sm:p-6">
            ...
            <button type="button" onClick={()=>void copyProductLink()} className="mt-2 w-full border-2 border-black bg-white px-3 py-2 font-mono text-[8px] font-black uppercase inline-flex items-center justify-center gap-2 hover:bg-neutral-100"><Copy className="w-3 h-3"/> COPY LINK</button><div className="mt-2"><CommerceReportButton targetType="product" targetId={productId} label="REPORT PRODUCT"/></div>
