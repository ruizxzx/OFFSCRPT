...
import { PayoutAdminPanel } from './PayoutAdminPanel';
import { FinanceAdminPanel } from './FinanceAdminPanel';
import { TrustModerationAdminPanel } from './TrustModerationAdminPanel';
...
const collections = [
  ...
  ['commerceAuditLogs','AUDIT EVENTS'],['commerceWebhookEvents','WEBHOOK EVENTS'],['commerceVendorLedger','VENDOR LEDGER'],['creatorCommerceBalances','BALANCES'],['commerceReviews','REVIEWS'],['commerceReports','REPORTS'],['commerceModerationCases','MODERATION CASES'],['commerceModerationActions','MODERATION AUDIT'],['commerceReviewAggregates','REVIEW AGGREGATES'],['dailyFinanceAggregates','FINANCE AGGREGATES']
] as const;
