...
const collections = [
  ...
  ['commerceAuditLogs','AUDIT EVENTS'],['commerceWebhookEvents','WEBHOOK EVENTS'],['commerceVendorLedger','VENDOR LEDGER'],['creatorCommerceBalances','BALANCES'],['dailyFinanceAggregates','FINANCE AGGREGATES']
] as const;
